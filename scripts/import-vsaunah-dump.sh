...
if [[ $# -lt 1 ]]; then
  echo "Usage: $0 path/to/vsaunah-draft-import.sql" >&2
  exit 2
fi
...
REMOTE_BACKUP="/tmp/onlyglamps-before-vsaunah-${STAMP}.dump"
LOCAL_BACKUP="${BACKUP_DIR}/onlyglamps-before-vsaunah-${STAMP}.dump"
